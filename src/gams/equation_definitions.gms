...
objDefFull..
  ...
  =e= costVar
   ...
   +  PowBalanceViolPen * sum(i$Bus(i),
          sqrt(1e-6 + sqr(busPowRealBalanceViolVar(i))))$PowBalanceQuadSoft
   +  PowBalanceViolPen * sum(i$Bus(i),
          sqrt(1e-6 + sqr(busPowImagBalanceViolVar(i))))$PowBalanceQuadSoft
...
#          + sqr(busPowImagBalanceViolVar(i)))$PowBalanceQuadSoft
   ...
   +  PowBalanceViolPen * sum((i,k)$(Bus(i) and CtgActive(k)),
          sqrt(1e-6 + sqr(busCtgPowRealBalanceViolVar(i,k))))$PowBalanceQuadSoft
   +  PowBalanceViolPen * sum((i,k)$(Bus(i) and CtgActive(k)),
          sqrt(1e-6 + sqr(busCtgPowImagBalanceViolVar(i,k))))$PowBalanceQuadSoft
